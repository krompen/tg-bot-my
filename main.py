...
async def safe_check_username(username: str) -> bool:
    ...
    try:
        ...
        logger.warning(f"FloodWait {e.seconds}s — переключаемся на Bot API")
        USE_TELETHON = False
    ...
    async with aiosqlite.connect(DB_NAME) as db:
        await db.execute(
            """INSERT OR IGNORE INTO users 
               (user_id, username, referral_code, referred_by, role) 
               VALUES (?, ?, ?, ?, 'user')""",
...
async def cache_username(username: str, is_free: bool):
    ...
    async with aiosqlite.connect(DB_NAME) as db:
        await db.execute(
            "INSERT OR REPLACE INTO username_cache (username, is_free) VALUES (?, ?)",
...
# ==================== ГЕНЕРАЦИЯ (400+ СЛОВ) ====================
ADJECTIVES = [
    "cool", "fast", "smart", "wild", "dark", "fire", "gold", "ice", "star", "neo",
    "ghost", "king", "shadow", "storm", "blade", "silent", "mystic", "royal", "crystal",
    "phantom", "eagle", "tiger", "dragon", "wolf", "hawk", "fox", "lion", "ninja",
    "cyber", "quantum", "cosmic", "eternal", "infinite", "prime", "alpha", "omega",
    "solar", "lunar", "stellar", "void", "neon", "arctic", "inferno", "thunder",
    "lightning", "frost", "ember", "raven", "phoenix", "serpent", "falcon", "viper",
    "midnight", "sunset", "aurora", "velvet", "onyx", "ruby", "sapphire", "emerald",
    "obsidian", "titanium", "platinum", "diamond", "silver", "bronze", "steel", "iron",
    "blood", "bone", "soul", "spirit", "dream", "night", "dawn", "dusk", "echo", "pulse",
    "nova", "zenith", "apex", "forge", "spire", "realm", "haven", "sanctum", "citadel",
    "fortress", "empire", "dynasty", "legacy", "myth", "legend", "saga", "chronos",
    "aether", "nyx", "gaia", "helios", "selene", "ares", "zeus", "hades", "poseidon",
    "thor", "odin", "loki", "fenrir", "valkyrie", "ragnarok", "asgard", "midgard"
]

NOUNS = [
    "wolf", "hawk", "fox", "lion", "eagle", "shadow", "storm", "blade", "ghost", "king",
    "dragon", "ninja", "phoenix", "raven", "serpent", "falcon", "viper", "tiger", "bear",
    "night", "void", "star", "cosmos", "nebula", "galaxy", "orbit", "pulse", "echo",
    "nova", "zenith", "apex", "forge", "spire", "realm", "haven", "sanctum", "citadel",
    "fortress", "empire", "dynasty", "legacy", "myth", "legend", "saga", "pulse",
    "echo", "nova", "zenith", "apex", "forge", "spire", "realm", "haven", "sanctum",
    "citadel", "fortress", "empire", "dynasty", "legacy", "myth", "legend", "saga",
    "wolfpack", "nightfall", "stormborn", "shadowveil", "fireheart", "iceborn", "starborn",
    "voidwalker", "dreamweaver", "soulreaver", "bloodmoon", "ironclad", "steelheart",
    "ravenwing", "phoenixfire", "dragonscale", "wolfspirit", "hawkseye", "foxfire",
    "lionheart", "eagleclaw", "serpenttongue", "falconwing", "viperstrike", "tigerclaw",
    "bearstrength", "nightshade", "voidheart", "stardust", "cosmicflow", "nebulacore",
    "galaxyeye", "orbitfall", "pulsewave", "echosong", "novaburst", "zenithpeak",
    "apexlord", "forgefire", "spirecrown", "realmwalker", "havenguard", "sanctumseal",
    "citadelking", "fortresslord", "empireborn", "dynastyrise", "legacyborn", "mythweaver",
    "legendborn", "sagaborn", "chronoslord", "aetherking", "nyxshadow", "gaiaborn",
    "heliosfire", "selenelight", "aresblood", "zeuslightning", "hadesveil", "poseidonwave",
    "thorhammer", "odinraven", "lokishadow", "fenrirhowl", "valkyrieblade", "ragnarokfire",
    "asgardgate", "midgardborn"
]
...
async def find_free_username(length: int, max_attempts: int = 80) -> str:
...
async def do_search(callback: CallbackQuery):
    ...
    if free_username:
        ...
        keyboard = InlineKeyboardMarkup(inline_keyboard=[
            ...
            [InlineKeyboardButton(text="🔄 Следующий", callback_data=f"search_{length}")],
...
async def main():
    ...
    logger.info("Финальный красивый бот с максимальной защитой запущен")
